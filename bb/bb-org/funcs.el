...
(defun bb-org/hexo-publish (commit-msg)
...
(defun bb-org/hexo-org-add-read-more ()
  "add <!--more-->"
  (interactive)
  (insert "#+BEGIN_HTML\n<!--more-->\n#+END_HTML"))

(defun bb-org/hexo-org-new-open-post (post-name)
...
(defun bb-org/word-count-for-chinese ()
  "「較精確地」統計中 / 日 / 英文字數。
- 文章中的註解不算在字數內。
...
(defun bb-org/hotspots ()
  "helm interface to my hotspots, which includes my locations,
org-files and bookmarks"
  (interactive)
  (helm :buffer "*helm: utities*"
        :sources `(,(bb-org//hotspots-sources))))

(defun bb-org//hotspots-sources ()
  "Construct the helm sources for my hotspots"
  `((name . "bb-org's center")
    (candidates . (
                   ...
                   ("Open Github" . (lambda() (browse-url "https://github.com/bb-org")))
                   ("Open Blog" . (lambda() (browse-url "http://bb-org.com")))))
    (candidate-number-limit)
    (action . (("Open" . (lambda (x) (funcall x)))))))

(defun bb-org/start-erc ()
  "Connect to IRC"
  (interactive)
...
(defun bb-org//notify (title message)
...
(defun bb-org//org-archive-tasks (prefix)
  (org-map-entries
   (lambda ()
     (org-archive-subtree)
...
(defun bb-org/org-archive-all-tasks ()
  (interactive)
  (bb-org//org-archive-tasks "DONE")
  (bb-org//org-archive-tasks "CANCELLED")
  (bb-org//org-archive-tasks "FIXED")
  )

;; I keep almost everything in one big org file.

(defvar org-gtd-file "~/Dropbox/org/gtd.org")
